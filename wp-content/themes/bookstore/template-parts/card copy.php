...
<div class="cards">
    ...
    <?php
    // Archive page has an entire grid area for cards, scroll button is not needed 
    if (!is_archive()): 
    ...
    while ($query -> have_posts()):
        ...
        if (!empty($features) && $fields['for_sales']): 
            foreach ($features as $feature):
                ...
                if ((!is_archive() && $feature -> slug === $feature_type) || (is_archive() && $genre -> slug === $slug)):
    ...
    <?php
    // Archive page has an entire grid area for cards, croll button is not needed 
    if (!is_archive()): 
